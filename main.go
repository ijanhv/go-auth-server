...
import (
	...
	"github.com/ijanhv/go-auth-server/data"
...
func main() {
	...
	app.Post("/signup", func(c *fiber.Ctx) error {
		...
		if req.Name == "" || req.Email == "" || req.Password == "" {
			return fiber.NewError(fiber.ErrBadRequest.Code, "Invalid signup credentials")
		}
	...
	app.Post("/login", func(c *fiber.Ctx) error {
		...
		if req.Email == "" || req.Password == "" {
			return fiber.NewError(fiber.ErrBadRequest.Code, "Invalid Login credentials")
		}
